    ...
    <div className="container mx-auto my-10 lg:px-4">
      <Card className="bg-black text-white p-8 md:p-12 md:m-20 mt-28 border-2 border-primary">
        ...
        <CardContent>
          ...
          <p className="mb-4">
            By using our services, you agree to these Terms of Service. If you
          ...
          <p className="mb-4">
            ...
            Service on our website. You are advised to review these terms
          ...
          <p className="mb-4">
            ...
            respect the rights of others. You are responsible for your own
            conduct and the content you submit.
          </p>
          ...
          <p className="mb-4">
            ...
            contact us at support@luvfindr.com.
          </p>
        </CardContent>
      </Card>
    </div>
